...
async function fetchInvoices() {
  tbody.innerHTML = '<tr><td colspan="5" style="text-align:center; padding:3rem; color:var(--text-muted);">Loading your invoices...</td></tr>';
  ...
  try {
    ...
    tbody.innerHTML = `<tr><td colspan="5" style="text-align:center; padding:3rem; color:#fca5a5;">Error: ${err.message}. Please check console and RLS policies.</td></tr>`;
  }
}

function renderTable() {
  if (invoices.length === 0) {
    tbody.innerHTML = '<tr><td colspan="5" style="text-align:center; padding:3rem; color:var(--text-muted);">You have no invoices.</td></tr>';
    return;
  }
